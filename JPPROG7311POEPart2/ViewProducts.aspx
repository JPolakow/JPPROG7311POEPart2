...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="form-container">
      ...
      <div class="filter-row">
         ...
         <asp:TextBox ID="txtStartDate" TextMode="Date" runat="server" CssClass="auto-style1" Width="150px" placeholder="Start Date"></asp:TextBox>
      </div>
      <div class="filter-row">
         <label for="txtEndDate">End Date:</label>
         <asp:TextBox ID="txtEndDate" TextMode="Date" runat="server" CssClass="auto-style1" Width="150px" placeholder="End Date"></asp:TextBox>
      </div>
      <div class="filter-row">
